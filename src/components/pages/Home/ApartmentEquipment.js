...
import AddMembers from "../../addEquipmentInformation/AddEquipmentInformation";
import ImportInventoryModal from "../../importInventoryModal/ImportInventoryModal";
import UpdateInventoryModal from "../../updateEquipmentInformation/UpdateEquipmentInformation";
...
export default function ApartmentEquipment(props) {
...
// setSome={this.setSome}
  ...
  const fetchData = () => {
    ...
    const data = [];
    state.rows = [];
    fetch("http://localhost:5000/api/equipmentInformationList")
      .then(res => res.json())
      .then(data => {
        // .table(data); 
