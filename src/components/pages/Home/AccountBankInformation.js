...
import AddMembers from "../../addBankInformation/AddBankInformation";
import ImportInventoryModal from "../../importInventoryModal/ImportInventoryModal";
import UpdateInventoryModal from "../../updateBankInformation/UpdateBankInformation";
...
export default function AccountBankInformation(props) {
...
// setSome={this.setSome}
  ...
  const fetchData = () => {
    ...
    const data = [];
    state.rows = [];
    fetch("http://localhost:5000/api/bankInformationList")
      .then(res => res.json())
      .then(data => {
        // .table(data); 
      ...
      >
        ...
        <div style={{ marginTop: "50px" }}>
          ...
          <MuiThemeProvider theme={getMuiTheme()}>
            <MUIDataTable
              title={"ACCOUNT BANK INFORMATION"}
              data={state.rows}
