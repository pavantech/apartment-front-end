...
import ImportInventoryModal from "../../importInventoryModal/NotificationImportModal";
...
import CustomToolbar from "../../customToolbar/NotificationCustomToolbar";
...
export default function NotificationInformation(props) {
...
// setSome={this.setSome}
  ...
  const fetchData = () => {
    ...
    const data = [];
    state.rows = [];
    fetch("http://localhost:5000/api/notificationList")
      .then(res => res.json())
      .then(data => {
        // .table(data); 
      ...
      >
        ...
        <div style={{ marginTop: "50px" }}>
          ...
          <MuiThemeProvider theme={getMuiTheme()}>
            <MUIDataTable
              title={"NOTIFICATION INFORMATTION"}
              data={state.rows}
